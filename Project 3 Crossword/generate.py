...
class CrosswordCreator():
        ...
        for variable, words in self.domains.items():
            ...
            for word in words:
                if len(word) != variable.length:
                    to_delete.add(word)
            self.domains[variable] -= to_delete
    ...
    def ac3(self, arcs=None):
        ...
        """
        if arcs is None:
            arcs = [(x, y) for x, y in self.crossword.overlaps.keys()]
    ...
    def assignment_complete(self, assignment: dict):
        ...
        for variable in self.crossword.variables:
            if variable not in assignment or assignment[variable] not in self.domains[variable] or assignment[variable] is None:
                return False
        return True
    ...
    def consistent(self, assignment):
        ...
        for variable in assignment:
            ...
            for word in assignment:
                if word != variable and assignment[word] == assignment[variable]:
                    return False
        return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        for word in self.domains[var]:
            count = 0
            for variable in self.crossword.variables - assignment.keys() - {var}:
        ...
        return [word for word, _ in sorted(values, key=lambda x: x[1])]
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return min(unassigned, key=lambda x: (len(self.domains[x]), -len(
            {y for y in self.crossword.variables if y != x and y in unassigned})))
